...
class FilmspiderSpider(scrapy.Spider):
    ...
    allowed_domains = ["filmaffinity.com/es"]

    start_urls = ["https://www.filmaffinity.com/es/ranking.php?rn=ranking_fa_movies"]

    # TODO: Hay que añadir cuando pueda fallar; si no se usa selenium-scrapy, cambiar linea 80
...
# Para ejecutar la araña, hay que asegurarse de estar en el directorio de spider de la terminal y poner scrapy crawl filmspider
